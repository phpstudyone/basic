...
class AuthorizenetController extends Controller{
    ...
    public function beforeAction($action)
    {
        ...
        $this->merchantAuthentication->setName('6A54Cdc9');
        $this->merchantAuthentication->setTransactionKey('6S4jWBU4d5vN9k9M');
    ...
    public function actionIndex(){
        ...
        $setting2->setSettingName('hostedProfilePageBorderVisible');
        $setting2->setSettingValue('false');
        $request->addToHostedProfileSettings($setting2);

        $setting3 = new AnetAPI\SettingType();
        $setting3->setSettingName('hostedProfileManageOptions');
        $setting3->setSettingValue('showPayment');
...
//        dump($response);die;
    ...
    {
        $profileId = '1812468160';
        return $this->redirect(['authorizenet/index','profileId'=>$profileId]);
//        die;
        $request = new AnetAPI\GetCustomerProfileRequest();
        $request->setMerchantAuthentication($this->merchantAuthentication);
        $request->setCustomerProfileId($profileId);
