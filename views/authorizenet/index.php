...
<!--<form method="post" action="https://test.authorize.net/customer/manage" target="add_payment">-->
<!--<form method="post" action="https://test.authorize.net/customer/editPayment" target="add_payment">-->
    <input type="hidden" name="token" value="<?php echo $token;?>"/>
<!--    <input type="hidden" name="paymentProfileId" value="1807430360"/>-->
